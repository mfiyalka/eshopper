            ...
            <div class="col-lg-4">
                <div class="login-form">
                    <form action="#" method="post">
                        ...
                        <p>Статус</p>
                        <select name="status">
                            <option value="1" <? if ($category['status'] == 1) echo ' selected="selected"'?>>Відображається</option>
                            <option value="0" <? if ($category['status'] == 0) echo ' selected="selected"'?>>Прихована</option>
                        </select>
